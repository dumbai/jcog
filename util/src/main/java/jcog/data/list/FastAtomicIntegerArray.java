...
public class FastAtomicIntegerArray {

    private static final VarHandle AA =
            MethodHandles.arrayElementVarHandle(int[].class).withInvokeExactBehavior();
     ...
     */
    public FastAtomicIntegerArray(int length) {
//        resize(length);
//    }
//
//
...
//        int[] a = this.array;
//        if (a.length!=length)
            array = new int[length];//Arrays.copyOf(array, length);
    }
