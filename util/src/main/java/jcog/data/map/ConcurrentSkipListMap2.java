...
//        Node<K,V> result;
    ...
    public ConcurrentSkipListMap2(Comparator<K> comparator) {
    ...
    public V getOrDefault(Object key, V defaultValue) {
        V v;
        return (v = doGet((K)key)) == null ? defaultValue : v;
    }
...
//        if (fromKey == null) throw new NullPointerException();
    ...
    static final class KeySet<K,V> extends AbstractSet<K> implements NavigableSet<K> {
        ...
        public Iterator<K> iterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).new KeyIterator()
        ...
        public Spliterator<K> spliterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).keySpliterator()
                    : ((SubMap<K,V>)m).new SubMapKeyIterator();
        }
    }
    ...
    static final class Values<K,V> extends AbstractCollection<V> {
        ...
        public Iterator<V> iterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).new ValueIterator()
        ...
        public Spliterator<V> spliterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).valueSpliterator()
                    : ((SubMap<K,V>)m).new SubMapValueIterator();
        }
...
//            if (filter == null) throw new NullPointerException();
            if (m instanceof ConcurrentSkipListMap2)
                return ((ConcurrentSkipListMap2<K,V>)m).removeValueIf(filter);
            // else use iterator
    ...
    static final class EntrySet<K,V> extends AbstractSet<Map.Entry<K,V>> {
        ...
        public Iterator<Map.Entry<K,V>> iterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).new EntryIterator()
                    : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        ...
        public Spliterator<Map.Entry<K,V>> spliterator() {
            return m instanceof ConcurrentSkipListMap2
                    ? ((ConcurrentSkipListMap2<K,V>)m).entrySpliterator()
                    : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        public boolean removeIf(Predicate<? super Map.Entry<K,V>> filter) {
//            if (filter == null) throw new NullPointerException();
            if (m instanceof ConcurrentSkipListMap2)
                return ((ConcurrentSkipListMap2<K,V>)m).removeEntryIf(filter);
            // else use iterator
            Iterator<Map.Entry<K,V>> it =
                    ((SubMap<K,V>)m).new SubMapEntryIterator();
            boolean removed = false;
...
//                throw new IllegalArgumentException("inconsistent range");
        ...
        boolean tooLow(K key) {
            int c;
            return lo != null && ((c = m.cmp(key, lo)) < 0 ||
                    c == 0 && !loInclusive);
        }

        boolean tooHigh(K key) {
            int c;
            return hi != null && ((c = m.cmp(key, hi)) > 0 ||
                    c == 0 && !hiInclusive);
        }
...
//                throw new IllegalArgumentException("key out of range");
        ...
        ConcurrentSkipListMap2.Node<K,V> loNode() {
            if (lo == null)
                ...
                return m.findNear(lo, loInclusive ? GT|EQ : GT);
        }
        ...
        ConcurrentSkipListMap2.Node<K,V> hiNode() {
            if (hi == null)
                ...
                return m.findNear(hi, hiInclusive ? LT|EQ : LT);
        }
...
//                    return last;
        ...
        Map.Entry<K,V> lowestEntry() {
            for (;;) {
                ConcurrentSkipListMap2.Node<K,V> n; V v;
        ...
        Map.Entry<K,V> removeLowest() {
            for (;;) {
                ConcurrentSkipListMap2.Node<K,V> n; K k; V v;
                if ((n = loNode()) == null)
                    return null;
...
//        if (function == null) throw new NullPointerException();
    ...
    abstract static class CSLMSpliterator<K,V> {
        ...
        CSLMSpliterator(Comparator<K> comparator, Index<K,V> row,
    ...
    static final class KeySpliterator<K,V> extends CSLMSpliterator<K,V>
        ...
        KeySpliterator(Comparator<K> comparator, Index<K,V> row,
                       Node<K,V> origin, K fence, long est) {
...
//            if (action == null) throw new NullPointerException();
    ...
    final KeySpliterator<K,V> keySpliterator() {
        ...
        return new KeySpliterator<>(comparator, h, n, null, est);
    }

    static final class ValueSpliterator<K,V> extends CSLMSpliterator<K,V>
            implements Spliterator<V> {
        ValueSpliterator(Comparator<K> comparator, Index<K,V> row,
                         Node<K,V> origin, K fence, long est) {
            super(comparator, row, origin, fence, est);
        }
...
//            if (action == null) throw new NullPointerException();
    ...
    static final class EntrySpliterator<K,V> extends CSLMSpliterator<K,V>
        ...
        EntrySpliterator(Comparator<K> comparator, Index<K,V> row,
                         Node<K,V> origin, K fence, long est) {
            super(comparator, row, origin, fence, est);
        }
...
//            }
    ...
    static {
        try {
            ...
            HEAD = l.findVarHandle(ConcurrentSkipListMap2.class, "head",
                    Index.class);
            ADDER = l.findVarHandle(ConcurrentSkipListMap2.class, "adder",
                    LongAdder.class);
