...
class PrintfFormat {
     ...
     *                                  malformed.
     */
    PrintfFormat(Locale locale, String fmtArg)
            throws IllegalArgumentException {
    ...
    private class ConversionSpecification {
         ...
         */
        private static boolean checkForCarry(char[] ca1, int icarry) {
            boolean carry = false;
         ...
         * more
         */
        private static boolean startSymbolicCarry(
        ...
        String internalsprintf(double s)
            ...
            return switch (conversionCharacter) {
                ...
                default -> throw new IllegalArgumentException("Cannot " +
